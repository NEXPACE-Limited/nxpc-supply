 ...
 *
 * Two things read it. The address tab wants the C-Chain balances to show, and
 * free float wants Avalanche circulating supply, which is derived here rather
 * than carried from chains.yaml — see avaxSupplySpec and offHenesysFrom. So a
 * failure here costs the address tab its C-Chain column AND drops the Avalanche
 * figure back to the surveyed number; the Henesys figures are unaffected.
 */
